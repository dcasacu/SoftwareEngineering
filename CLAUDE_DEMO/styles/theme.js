...
export const createStyles = () => ({
  ...
  toast: (show, type = "default") => {
    const typeStyles = {
      ...
      yourTurn: { background: "#000000", border: `3px solid ${COLORS.accent}`, boxShadow: `0 0 30px ${COLORS.accent}80, 0 0 60px ${COLORS.accent}40, ${SHADOWS.xl}` },
    ...
    return {
      ...
      opacity: show ? 1 : 0,
      color: COLORS.white,
      padding: isYourTurn ? "20px 28px" : "16px 24px",
      borderRadius: RADIUS.xl,
      fontWeight: isYourTurn ? TYPOGRAPHY.weights.extrabold : TYPOGRAPHY.weights.semibold,
      fontSize: isYourTurn ? TYPOGRAPHY.sizes.lg : TYPOGRAPHY.sizes.base,
      zIndex: isYourTurn ? 99999 : 999,
      ...
      gap: 12,
      maxWidth: "90%",
      minWidth: isYourTurn ? 260 : undefined,
      ...typeStyles[type],
    };
  },
